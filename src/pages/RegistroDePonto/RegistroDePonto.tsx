...
import { tPonto, iPontoModalProps } from '../../Interfaces/Types';
import { Styles } from '../../Styles';
import { NavigationContainer } from '@react-navigation/native';
import { useLiveClock } from '../../Hooks/LiveClock';
...
export default function RegistroDePonto ({ navigation }: any) {
  ...
  const [dtaClock, setClockId] = useLiveClock(setInterval(() => new Date(Date.now()), 1000)); // Inicializa o relógio.
  ...
  function ListarPonto({lstPonto}: iPontoModalProps) {  
    return (
      <View>
        {
