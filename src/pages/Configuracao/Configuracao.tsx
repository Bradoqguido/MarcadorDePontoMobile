...
export default function Configuracao() {
  ...
  const showMode = (currentMode: any) => {
    setShow(true);
    setMode(currentMode);
    setDate(isNullOrUndefined(date) ? new Date() : date);
  };
        ...
        <View style={Styles.cardActions}>
          <View style={Styles.cardActionButtons}>
            <FontAwesome.Button
              ...
              onPress={() => {
                showMode("time");
                setHorarioInicioExpediente(date);
              }}>
              Definir
            </FontAwesome.Button>
          </View>
